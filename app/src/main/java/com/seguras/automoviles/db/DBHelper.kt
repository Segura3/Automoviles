...
open class DBHelper(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        p0?.execSQL("CREATE TABLE $TABLE_AUTOS (id INTEGER PRIMARY KEY AUTOINCREMENT, modelo TEXT NOT NULL, hp SMALLINT NOT NULL, year YEAR NOT NULL, brand TEXT NOT NULL)")
    }
